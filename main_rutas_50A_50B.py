...
def geocodificar_referencia(texto):
    clave = texto.strip().lower()

    if clave in cache_rutas_mapa:
        return cache_rutas_mapa[clave]
...
def obtener_rutas_mapa():
    ...
    for linea, referencias in RUTAS.items():
        ...
        for referencia in referencias:
            punto = geocodificar_referencia(referencia)
