...
<body>
  ...
  <script>
    ...
    // Paradas principales indicadas para las líneas 50A / 50B.
    // Coordenadas obtenidas de los enlaces de Google Maps enviados.
    const PARADAS = [
      {
        nombre: "Rivadavia",
        lat: -38.957381,
        lon: -68.226198,
        detalle: "Parada Rivadavia"
      },
      {
        nombre: "Las Lajas",
        lat: -38.9508355,
        lon: -68.228275,
        detalle: "Parada Las Lajas"
      },
      {
        nombre: "Av. Belgrano y Pulmarí",
        lat: -38.9533476,
        lon: -68.2375682,
        detalle: "Parada Av. Belgrano y Pulmarí"
      }
    ];
      ...
      PARADAS.forEach(parada => {
        ...
        marker.bindPopup(`
          <div style="font-family:sans-serif; min-width:180px;">
            <strong style="font-size:14px; color:#111;">🚏 ${parada.nombre}</strong>
    ...
    function initMap() {
      ...
      // Las paradas quedan visibles permanentemente en el mapa.
      mostrarParadas();
    }
